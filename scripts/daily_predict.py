...
def format_data_update_command(
    ...
    context = {
        ...
        "data_update_source": str(update_config.get("source", "")),
        "data_update_sources": str(update_config.get("sources", "")),
        "data_update_end_date": str(update_config.get("end_date", "today")),
        ...
        "data_update_work_dir": str(update_config.get("work_dir", "")),
        "data_update_max_workers": str(update_config.get("max_workers", "")),
        "data_update_source_workers": str(update_config.get("source_workers", "")),
        "data_update_delay": str(update_config.get("delay", "")),
        "data_update_retry_count": str(update_config.get("retry_count", "")),
        "data_update_source_cooldown": str(update_config.get("source_cooldown", "")),
        "data_update_max_source_cooldown": str(update_config.get("max_source_cooldown", "")),
        "data_update_source_consecutive_failures": str(update_config.get("source_consecutive_failures", "")),
        "data_update_source_min_attempts": str(update_config.get("source_min_attempts", "")),
        "data_update_source_error_rate": str(update_config.get("source_error_rate", "")),
        "data_update_source_disable_after_cooldowns": str(update_config.get("source_disable_after_cooldowns", "")),
